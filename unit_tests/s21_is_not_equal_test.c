...
START_TEST(is_not_equal_2) {
  ...
  s21_set_bit_on_index(&val1, 33, 1);
  s21_set_bit_on_index(&val2, 33, 1);
  ck_assert_int_eq(1, s21_is_not_equal(val1, val2));
}
END_TEST
...
START_TEST(is_not_equal_5) {
  s21_decimal val1 = {{0}};
  s21_decimal val2 = {{0}};
  s21_set_mantissa(&val1, 3);
  s21_set_mantissa(&val2, 3);
  ck_assert_int_eq(0, s21_is_not_equal(val1, val2));
}
END_TEST

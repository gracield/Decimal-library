...
START_TEST(is_less_4) {
  s21_decimal val1 = {{0}};
  s21_decimal val2 = {{0}};
  s21_set_bit_on_index(&val1, 127, 1);
  ck_assert_int_eq(0, s21_is_less(val1, val2));
}
END_TEST
...
START_TEST(is_less_5) {
  ...
  val1.bits[2] = 256;
  val2.bits[2] = 257;
  s21_set_mantissa(&val1, 11);
  s21_set_mantissa(&val2, 10);
  ck_assert_int_eq(1, s21_is_less(val1, val2));
}
END_TEST
...
START_TEST(is_less_6) {
  ...
  val1.bits[2] = 256;
  val2.bits[2] = 257;
  s21_set_mantissa(&val1, 10);
  s21_set_mantissa(&val2, 11);
  ck_assert_int_eq(0, s21_is_less(val1, val2));
}
END_TEST
...
START_TEST(is_less_7) {
  ...
  s21_decimal val2 = {{0}};
  val2.bits[2] = 257;
  s21_set_mantissa(&val1, 127);
  s21_set_mantissa(&val2, 127);
  ck_assert_int_eq(1, s21_is_less(val1, val2));
}
END_TEST
...
START_TEST(is_less_8) {
  ...
  s21_decimal val2 = {{0}};
  s21_set_bit_on_index(&val1, 127, 1);
  s21_set_bit_on_index(&val2, 127, 1);
  s21_set_bit_on_index(&val1, 83, 1);
  s21_set_mantissa(&val1, 12);
  s21_set_mantissa(&val2, 11);
  ck_assert_int_eq(1, s21_is_less(val1, val2));
}
END_TEST
...
START_TEST(is_less_9) {
  ...
  s21_set_bit_on_index(&val2, 127, 1);
  s21_set_bit_on_index(&val1, 83, 1);
  s21_set_bit_on_index(&val2, 83, 1);
  s21_set_mantissa(&val1, 10);
  s21_set_mantissa(&val2, 11);
  ck_assert_int_eq(1, s21_is_less(val1, val2));
}
...
START_TEST(is_less_11) {
  ...
  s21_decimal val2 = {{0}};
  s21_set_bit_on_index(&val1, 127, 1);
  s21_set_bit_on_index(&val2, 127, 0);
  s21_set_bit_on_index(&val1, 83, 1);
  ck_assert_int_eq(1, s21_is_less(val1, val2));
}
END_TEST

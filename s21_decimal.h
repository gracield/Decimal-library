...
int s21_get_bit_on_index_big(s21_big_decimal src, int index);
...
int s21_get_bit_on_index(s21_decimal src, int index);
int s21_get_mantissa(s21_decimal dst);
int s21_get_sign(s21_decimal dst);

void s21_set_bit_on_index(s21_decimal *dst, int index, int bit);
void s21_set_mantissa(s21_decimal *dst, int mantissa);
...
void s21_normalize_mantissa_upper(s21_decimal *d, int norm);
void s21_copy_decimal(s21_decimal *d1, s21_decimal d2);
int s21_post_normalization(s21_big_decimal *result, int mantissa);
